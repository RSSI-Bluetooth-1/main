...
static char  interesting_addr[BT_ADDR_STR_LEN-1] = "E2:52:86:A9:3D:62";
		    ...
		    struct net_buf_simple *buf)
{
	...
	if (!strncmp(addr_str, interesting_addr, BT_ADDR_STR_LEN-1)){ //BT_ADDR_STR_LEN is 18 for some reason..
